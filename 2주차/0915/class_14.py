...
# 빈 상품 리스트가 있고 리스트에 상품의 이름과 가격을 추가해 줄 수 있다. 
# 상품이 처음 들어오면 재고는 수량을 1으로 설정
...
# 제품 추가
products.append(Product("에어팟", 350000, 1))
...
print(f"전체 재고: {total_stock}")

# 제품 삭제 - 수량이 남아 있으면 삭제 불가
# 현재 모든 제품의 수량의 합